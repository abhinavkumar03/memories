...
const PostDetails = () => {
  ...
  if (isLoading) {
    return (
      <Paper elevation={6} className={classes.loadingPaper} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px', borderRadius: '15px', height: '39vh' }}>
